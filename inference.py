...
def get_parser():
    ...
    if in_server:
        ...
        parser.add_argument('--model_name', type=str, default='/mnt/afs/pretrian_weight/TrajectoryCrafter/CogVideoX-Fun-V1.1-5b-InP', help='Path to the model')
        # parser.add_argument(
        #     '--model_name',
        #     type=str,
        ...
        parser.add_argument('--transformer_path', type=str, default='/mnt/afs/pretrian_weight/TrajectoryCrafter/TrajectoryCrafter', help='Path to the pretrained transformer model')
        # parser.add_argument(
        #     '--transformer_path',
        #     type=str,
        ...
        parser.add_argument('--blip_path', type=str, default="/mnt/afs/pretrian_weight/TrajectoryCrafter/blip2-opt-2.7b")

        ## depth
        parser.add_argument('--unet_path', type=str, default='/mnt/afs/pretrian_weight/TrajectoryCrafter/DepthCrafter', help='Path to the UNet model')
        # parser.add_argument(
        #     '--unet_path',
        #     type=str,
        ...
        parser.add_argument('--pre_train_path', type=str, default='/mnt/afs/pretrian_weight/TrajectoryCrafter/stable-video-diffusion-img2vid', help='Path to the pre-trained model')
        # parser.add_argument(
        #     '--pre_train_path',
        #     type=str,
        #     default="stabilityai/stable-video-diffusion-img2vid-xt", #? 是用 xt？
        #     help='Path to the pre-trained model',
        # )
        parser.add_argument(
            '--cpu_offload', type=str, default='model', help='CPU offload strategy'  # for depthcrafter
        )
        parser.add_argument(
